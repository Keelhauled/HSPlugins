...
{
    public class ModMenuManagerPlugin : IEnhancedPlugin
    {
        public const string PLUGIN_NAME = "ModMenuManager";
        ...
        {
            if(SceneFilter.Contains(SceneManager.GetActiveScene().name)) new GameObject(PLUGIN_NAME).AddComponent<ModMenuManager>();
        }
